        ...
        flex items-center justify-center px-4 py-8">
            ...
            <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-2">
                            ...
                            {/* <NavLink to="/" className="text-sm text-blue-600 hover:text-blue-500 transition-colors">
                                Forgot password?
                            </NavLink> */}
                        </div>
                        <input 
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <button className="flex items-center justify-center gap-2 border border-gray-300 
                    rounded-lg py-3 px-4 hover:bg-gray-50 transition-colors duration-200">
